...
describe('LoginRegisterComponent', () => {
  ...
  it('should set error flags when form is invalid', () => {
    ...
    component.userModel.confirmPassword = '';

    component.onSubmit();

    expect(component.errors.usernameError).toBeTrue();
    expect(component.errors.emailError).toBeTrue();
    expect(component.errors.passwordError).toBeTrue();
    expect(component.errors.confirmPasswordMismatchError).toBeTrue();
  });
